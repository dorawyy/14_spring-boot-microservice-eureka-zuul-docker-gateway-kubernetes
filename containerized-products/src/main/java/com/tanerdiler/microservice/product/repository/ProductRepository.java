...
public class ProductRepository {
	...
	static {
		products.put(1, new Product(1, "5 saatlik şarj aleti", 100D)); // call
		products.put(2, new Product(2, "traş makinası", 5D)); // call
		products.put(3, new Product(3, "klavye", 200D)); // call
		products.put(4, new Product(4, "sırt çantası", 50D)); // call
	}
